//import logo from './logo.svg'; kaks kalskriipsu on välja kommenteerimine
import './App.css';
import {useRef, useState} from "react";

// sonum - sõna mis hakkab muutuma EHK "muutuja"
// muudaSonum - sõna mille välja kutsydes saab muutujat muuta EHK "funktsioon"
...
function sisesta() {
  ...
  if (isikRef.current.value.startsWith(".")){
    muudaSonum("Nimi ei tohi alata punktiga!")
    return; // ära enam siit edasi mine
  }
